...
},{"unique-random-array":"../../node_modules/unique-random-array/index.js","./data/en.json":"../../node_modules/pokemon/data/en.json"}],"gens.js":[function(require,module,exports) {
"use strict";
...
var findPokemon = function findPokemon(pokemon) {
  ...
  var api = BASE_URL + pokemon.toLowerCase();
...
var addPokemonToCollection = function addPokemonToCollection() {
  ...
  var pkType = document.getElementById('pk-type').innerText;
  console.log("Pokemon: ".concat(pkName, " - ").concat(pkId, " with type: ").concat(pkType, " "), pkImg); // Create Pokemon Card
...
},{"./gens":"gens.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
btnCatch.addEventListener('click', function (e) {
  (0, _utils.addPokemonToCollection)();
});
