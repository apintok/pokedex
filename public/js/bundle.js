...
},{"unique-random":"../../node_modules/unique-random/index.js"}],"../../node_modules/pokemon/data/en.json":[function(require,module,exports) {
...
},{}],"../../node_modules/pokemon/index.js":[function(require,module,exports) {
'use strict';

var uniqueRandomArray = require('unique-random-array');

var pokemon = require('./data/en.json');

var repositoryUrl = 'https://github.com/sindresorhus/pokemon';
var reportText = "Please report to ".concat(repositoryUrl, "/issues if we missed something.");
var languages = new Set(['de', 'en', 'fr', 'ja', 'ko', 'ru', 'zh-Hans', 'zh-Hant']);
var randomNameGenerators = new Map();
...
function getLocalizedList() {
  ...
  return require("./data/".concat(language.toLowerCase(), ".json"));
}
...
exports.random = function () {
  ...
  var list = getLocalizedList(language);
...
},{"unique-random-array":"../../node_modules/unique-random-array/index.js","./data/en.json":"../../node_modules/pokemon/data/en.json"}],"../../node_modules/regenerator-runtime/runtime.js":[function(require,module,exports) {
var define;
/**
...
},{"./lib/axios":"../../node_modules/axios/lib/axios.js"}],"gens.js":[function(require,module,exports) {
"use strict";
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 8:
            ...
            console.log('GetPokemonData - Error: ', _context.t0.code);
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.next = 4;
            return getPokemonData(pokemon.toLowerCase());

          case 4:
            newPokemon = _context2.sent;
            console.log('New Pokémon: ', newPokemon);
            pkCard = document.querySelector('.pk-card');
            ...
            spinner.style.display = 'none'; // Add Event Listernt to pkImg
...
var addPokemonToCollection = function addPokemonToCollection() {
  ...
  var pkImg = document.getElementById('pk-img').src;
  var pkName = document.getElementById('pk-name').innerText;
  var pkId = document.getElementById('pk-id').innerText;
  var pkType = document.getElementById('pk-type').innerText; // Create Pokemon Card
  ...
  var pkCardImgDiv = document.createElement('DIV');
  var pkCardImg = document.createElement('IMG');
  ...
  pkCardId.innerText = "#".concat(pkId);
...
var getPokemonType = function getPokemonType(types) {
  var pkTypes = [];
  ...
  var pkTypesTest = pkTypes.length < 2 ? "".concat(pkTypes[0]) : "".concat(pkTypes[0], "/").concat(pkTypes[1]);
  return pkTypesTest;
};
